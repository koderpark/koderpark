...
export default function Hero() {
  return (
    ...
    >
      <div 
        className="w-[64rem] bg-cover bg-center bg-no-repeat relative flex items-center justify-center rounded-[2rem]"
        style={{
      ...
      >
        ...
        <div className="relative z-10 w-full px-4 sm:px-8 py-16">
          ...
          <p className="text-base sm:text-lg text-gray-200">
            ...
            블로그에 지식을 정리하고, 동아리 운영진으로 활동하며, 컨퍼런스에 참여하는등 적극적으로 활동해 왔습니다. <br/>
            이러한 과정에서 시야를 넓혀왔고, 꾸준한 학습과 경험을 통해 전문적인 SW Engineer가 되고자 합니다. <br/>
